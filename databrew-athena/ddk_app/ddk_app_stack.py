...
from aws_cdk.aws_iam import Effect, PolicyStatement, ServicePrincipal, Role, ManagedPolicy, PolicyDocument

from aws_cdk.aws_databrew import CfnDataset, CfnRecipe
from aws_cdk import aws_lambda as _lambda
from aws_cdk import custom_resources as cr
from aws_cdk import CustomResource, CustomResourceProvider
...
from aws_ddk_core.resources import S3Factory, DataBrewFactory, LambdaFactory
...
class DdkApplicationStack(BaseStack):
    ...
    def __init__(self, scope: Construct, id: str, environment_id: str, **kwargs: Any) -> None:
        ...
        marketing_job = self._create_databrew_environment(input_bucket, 
                                                        output_bucket,environment_id)
    ...
    def _create_databrew_environment(self,input_bucket : Bucket, output_bucket : Bucket, environment_id : str) -> databrew.CfnJob :
        ...
        if(recipe_publisher_function.role):
            recipe_publisher_function.role.add_to_policy(PolicyStatement(
        ...
        custom_resource = CustomResource(
            ...
            properties = {
                "RecipeName": databrew_job_recipe.name
            }
        )

        # retriving the version number from the lambda response
        databrew_job_recipe_version_number  = custom_resource.get_att_string("RecipeVersion")
    ...
    def _create_pipeline(self,marketing_job: databrew.CfnJob, output_bucket : Bucket, marketing_database : Database, environment_id : str):
